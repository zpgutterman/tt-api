...
public class DishRestService {
	...
	public List<Dish> listAllDishes() {
		return dishDao.findAllOrderedByName();
	}

	@GET
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public Dish lookupDishById(@PathParam("id") int id) {
	...
	@DELETE
	@Path("{dishid:[0-9][0-9]*}")
	public void deleteDish(@PathParam("dishid") int id) {
		dishDao.removeDish(lookupDishById(id));
	}
}
